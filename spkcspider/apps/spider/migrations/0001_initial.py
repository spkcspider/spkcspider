# Generated by Django 2.0.5 on 2018-06-05 23:34
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(editable=False, primary_key=True, serialize=False)),
                ('accessid', models.BigIntegerField(default=django.db.models.expressions.F('id'))),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('modified', models.DateTimeField(auto_now=True)),
                ('deletion_requested', models.DateTimeField(default=None, null=True)),
        ...
        migrations.AlterUniqueTogether(
            name='usercontent',
            unique_together={('content_type', 'object_id'), ('usercomponent', 'accessid')},
        ),
        migrations.AddIndex(

# Generated by Django 2.0.5 on 2018-05-27 13:44
...
import spkcspider.apps.spider.protections
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ptype', models.CharField(default=spkcspider.apps.spider.protections.ProtectionType('\x01'), max_length=10)),
            ],
        ),
        migrations.CreateModel(
            name='UserComponent',
            fields=[
                ...
                ('protections', models.ManyToManyField(through='spider_base.AssignedProtection', to='spider_base.Protection')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('usercomponent', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='contents', to='spider_base.UserComponent')),
            ],
            options={

# Generated by Django 2.0.5 on 2018-05-29 23:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.SlugField(max_length=15, primary_key=True, serialize=False)),
            ],
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='usercontent',
            name='usercomponent',
            field=models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='contents', to='spider_base.UserComponent'),
        ),
        migrations.AddField(

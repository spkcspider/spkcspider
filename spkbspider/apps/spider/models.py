...
class UserComponent(models.Model):
    ...
    def auth_test(self, request, scope, ptype=0):
...
class Protection(models.Model):
    ...
    # 0: access control, 1: authenticate, 2: recovery
    ptype = models.PositiveIntegerField(default=1)
    # type
...
class AssignedProtection(models.Model):
    ...
    # fix linter warning
    objects = models.Manager()
    protection = models.ForeignKey(Protection, on_delete=models.CASCADE, related_name="assigned", limit_choices_to=AssignedProtection.get_limit_choices, editable=False)

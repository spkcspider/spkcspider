...
from .views import ContentIndex, ContentAdd, ContentUpdate, ContentRemove
...
urlpatterns = [
    ...
    #url(r'^(?P<user>[-\w]+)/remove/(?P<name>[-\w]+)/(?P<id>[0-9]+)/$', ContentDelete.as_view(), name='ucontent-remove'),

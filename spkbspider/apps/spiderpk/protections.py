...
class AssignedProtection(models.Model):
    protection = models.ForeignKey("spiderpk.Protection", on_delete=models.CASCADE, related_name="assigned", limit_choices_to={"code__in": "installed_protections"}, editable=False)
    usercomponent = models.ForeignKey(swapper.get_model_name('spiderpk', 'UserComponent'), on_delete=models.CASCADE, editable=False)
    # data for protection

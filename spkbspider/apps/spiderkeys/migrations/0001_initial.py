    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('protected_by', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='publickeys', to=settings.SPIDER_USERCOMPONENT_MODEL)),
